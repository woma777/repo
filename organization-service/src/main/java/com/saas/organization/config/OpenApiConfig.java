    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0")
                        .description("OpenApi documentation for organization service")
                        ...
                        .license(new License()
                                .name("Licence name")
                                .url("Licence url")))
                .addServersItem(new Server().url("http://"+ipAddress+":8181").description("Remote ENV"))
                .addServersItem(new Server().url("http://localhost:8181").description("Local ENV"))
